...
namespace SE214L22.Core.Services
{
    public class UserService : BaseService, IUserService
    {
        ...
        public UserService(IUserRepository userRepository, IRoleRepository roleRepository, ISession session)
        {
        ...
        public User Login(LoginDto loginDto)
        {
            ...
            // compare password?
            if (user == null || !_session.ComparePassword(loginDto.Password, user.Password))
        ...
        public string GetNewPassword(int userId)
        {
            ...
            var newPassword = _session.GetNewPassword();

            // 2. Hash new password just generated
            var hashedPassword = _session.HashPassword(newPassword);
        ...
        {
            var hashedPassword = _session.HashPassword(userForPasswordUpdate.Password);
