...
namespace SE214L22.Core.Services
{
    public class InvoiceService : BaseService, IInvoiceService
    {
        ...
        public InvoiceService(IInvoiceRepository invoiceRepository, ICustomerRepository customerRepository, IInvoiceProductRepository invoiceProductRepository, IProductRepository productRepository, ICustomerLevelRepository customerLevelRepository)
        {
